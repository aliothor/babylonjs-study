...
export default class ParticleStartSizesChangeOverDuration {
  engine: Engine;

  constructor(private readonly canvas: HTMLCanvasElement) {
    document.querySelector<HTMLHtmlElement>("h1")!.innerHTML =
      "Particle Start Sizes Change Over Duration";
  ...
  async CreateScene(): Promise<Scene> {
    ...
    ptcSys.addStartSizeGradient(0, 0.25);
    ptcSys.addStartSizeGradient(1, 8);
