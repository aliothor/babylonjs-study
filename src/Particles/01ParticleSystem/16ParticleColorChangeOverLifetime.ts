...
export default class ParticleColorChangeOverLifetime {
  engine: Engine;

  constructor(private readonly canvas: HTMLCanvasElement) {
    document.querySelector<HTMLHtmlElement>("h1")!.innerHTML =
      "Particle Color Change Over Lifetime";
  ...
  async CreateScene(): Promise<Scene> {
    ...
    ptcSys.addColorGradient(0, new Color4(1, 0, 0, 1), new Color4(1, 0, 1, 1));
    ptcSys.addColorGradient(1, new Color4(0, 1, 0, 1), new Color4(1, 1, 0, 1));
