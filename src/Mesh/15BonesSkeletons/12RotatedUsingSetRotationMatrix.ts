...
export default class RotatedUsingSetRotationMatrix {
  engine: Engine;

  constructor(private readonly canvas: HTMLCanvasElement) {
    document.querySelector<HTMLHtmlElement>('h1')!.innerHTML = 'Rotated Using SetRotationMatrix'
  ...
  async CreateScene(): Promise<Scene> {
    ...
    scene.onBeforeRenderObservable.add(() => {
      ...
      skeleton.bones[2].setRotationMatrix(arrow.getWorldMatrix(), Space.WORLD, mesh)
    })
