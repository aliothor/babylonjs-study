...
export default class SetPivotPointByMatrix {
  engine: Engine;
  scene: Scene;

  constructor(private readonly canvas: HTMLCanvasElement) {
    document.querySelector<HTMLHtmlElement>('h1')!.innerHTML = 'Set Pivot Point by Matrix'
  ...
  CreateScene(): Scene {
    ...
    box.setPivotMatrix(Matrix.Translation(1, 1, 1))
