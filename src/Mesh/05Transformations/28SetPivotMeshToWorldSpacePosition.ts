...
export default class SetPivotMeshToWorldSpacePosition {
  engine: Engine;
  scene: Scene;

  constructor(private readonly canvas: HTMLCanvasElement) {
    document.querySelector<HTMLHtmlElement>('h1')!.innerHTML = 'Set Pivot Mesh to A World Space Position'
  ...
  CreateScene(): Scene {
    ...
    const sphereOrigin = MeshBuilder.CreateSphere('sphereOrigin', {diameter: 0.5})
    sphereOrigin.position = new Vector3(1, 0, 0)
