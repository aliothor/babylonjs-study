...
export default class CreatePolygonWithHoles {
  engine: Engine;
  scene: Scene;

  constructor(private readonly canvas: HTMLCanvasElement) {
    document.querySelector<HTMLHtmlElement>('h1')!.innerHTML = 'Create a Polygon With Holes'
  ...
  CreateScene(): Scene {
    ...
    const polygon = MeshBuilder.CreatePolygon('polygon', {
      shape,
      holes,
