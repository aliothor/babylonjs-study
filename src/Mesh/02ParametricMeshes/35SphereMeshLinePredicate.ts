import { ArcRotateCamera, Color3, Color4, CreateGreasedLine, CubeTexture, Engine, GreasedLineMeshColorMode, GreasedLineMeshMaterialType, GreasedLineTools, MeshBuilder, PBRMaterial, Scene, Vector3 } from "babylonjs";
...
export default class SphereMeshLinePredicate {
  ...
  CreateScene(): Scene {
    ...
    const line = CreateGreasedLine('line', {
      points: GreasedLineTools.MeshesToLines([sphere], predicate)
    }, {
