...
export default class CustomExtrusion {
  engine: Engine;
  scene: Scene;

  constructor(private readonly canvas: HTMLCanvasElement) {
    document.querySelector<HTMLHtmlElement>('h1')!.innerHTML = 'Custom Extrusion Basic Parameters'
  ...
  CreateScene(): Scene {
    ...
    const extrusion = MeshBuilder.ExtrudeShapeCustom('extrusion', {
      shape: myShape,
      path: myPath,
