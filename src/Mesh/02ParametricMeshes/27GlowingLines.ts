import { ArcRotateCamera, Color3, CreateGreasedLine, Engine, GlowLayer, GreasedLineMeshColorDistribution, HemisphericLight, Scene, Vector3 } from "babylonjs";

export default class GlowingLines {
  engine: Engine;
  scene: Scene;

  constructor(private readonly canvas: HTMLCanvasElement) {
    document.querySelector<HTMLHtmlElement>('h1')!.innerHTML = 'Glowing Lines'
