import { ArcRotateCamera, Color3, Debug, DynamicTexture, Engine, HemisphericLight, Mesh, MeshBuilder, Scene, StandardMaterial, Vector3, VertexBuffer, VertexData } from "babylonjs";

export default class CustomMeshWithNormals {
  engine: Engine;
  scene: Scene;

  constructor(private readonly canvas: HTMLCanvasElement) {
    document.querySelector<HTMLHtmlElement>('h1')!.innerHTML = 'Custom Mesh With Normals'
